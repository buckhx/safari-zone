...
func (BattleMessage_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptorSafari, []int{2, 0} }
...
type BattleMessage struct {
	...
	Status BattleMessage_Status `protobuf:"varint,2,opt,name=status,proto3,enum=buckhx.safari.zone.BattleMessage_Status" json:"status,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("buckhx.safari.zone.BattleMessage_Status", BattleMessage_Status_name, BattleMessage_Status_value)
...
func (m *BattleMessage) MarshalTo(data []byte) (int, error) {
	...
	if m.Status != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintSafari(data, i, uint64(m.Status))
	}
	return i, nil
}
...
var fileDescriptorSafari = []byte{
	...
	,
}
